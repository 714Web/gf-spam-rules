<?php
// Test for sofw_gform_content_blacklist
if (!class_exists('GFSpamRules')) { class GFSpamRules { public static function get_plugin_settings($form = null) { return ['content_blacklist'=>'foo','content_blacklist_add'=>'bar']; } } }
...
$form = ['fields' => [new class { public $id = 1; public function is_administrative() { return false; } public function get_input_type() { return 'text'; } public function get_value_export($entry) { return $entry['1']??''; } }]];
$entry1 = ['1' => 'foo'];
$entry2 = ['1' => 'bar'];
$entry3 = ['1' => 'baz'];
$res1 = $core->sofw_gform_content_blacklist(false, $form, $entry1);
echo "Test 1 (foo): ".($res1 === true ? 'PASS' : 'FAIL')."\n";
$res2 = $core->sofw_gform_content_blacklist(false, $form, $entry2);
echo "Test 2 (bar): ".($res2 === true ? 'PASS' : 'FAIL')."\n";
$res3 = $core->sofw_gform_content_blacklist(false, $form, $entry3);
